...
class Flight:
    ...
    def __str__(self):
        return (
            f"Flight ID : {self.flight_id} | Destination : {self.destination} | "
            f"Date : {self.date} | Price : Rs.{self.price} | "
...
class Booking:
    ...
    def __str__(self):
        return (
            f"Booking ID : {self.booking_id} | Passenger Name : {self.passenger_name} | "
            f"Flight : {self.flight.destination} On {self.flight.date} | "
            f"Date Booked : {self.date_booked}"
        )
...
class FlightBookingApp:
    ...
    def book_flight(self):
        ...
        try:
            flight_id_input = input("Enter Flight ID to Book: ").strip()
            passenger_name = input("Enter your Name: ").strip()
        except EOFError:
            print("\nNo input available. Returning to main menu.")
            return
    ...
    def start(self):
        ...
        while True:
            ...
            try:
                ...
                print("\nNo input available. Exiting the Flight Booking System.")
                break
